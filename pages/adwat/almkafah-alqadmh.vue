...
// Also update on server-side for better SEO and initial render
...
const seo = {
  ...
  description: `تصرف المكافأة تمام الساعة 12
  في ${formatDate(nextPaymentDate.value)}
  تبقى ${timeLeft.value.days} يوم
  ادخل الموقع لتفاصيل أكثر وأدق`
};
useSeoMeta(seo);
