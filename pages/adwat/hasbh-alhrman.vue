<template>
    <div class="mb-8 typography">
        <ProseH1>حاسبة المعدل</ProseH1>
        <Info>
            <b>كل نشاط منفصل</b>، مثلا تقدر تغيب 10% في <code>نشاط 1</code> و10% في <code>نشاط 2</code> بدون حرمان، نفس
            الشيء مع النشاط النظري والعملي.
        </Info>
        <Info>
            عدد الساعات يقصد فيه <b>الساعات الفعلية اللي تحتاج تحضرها</b>، فمثلا اذا كانت مدة المحاضرة ساعتين وكانت
            محاضرة واحدة فقط كل اسبوع، هذا يعني انه عدد الساعات في الاسبوع هو 2
        </Info>
    </div>
    <div class="space-y-2">
        <!-- مدخلات البيانات -->
        <div class="grid grid-cols-2">
            ...
            <div class="relative">
                ...
                <span
                    class="absolute transform -translate-y-1/2 pointer-events-none top-1/2 end-8 text-muted-foreground max-w-32 sm:max-w-none">
